define('ultra.lastfm.api', function(require) { 'use strict';
  var ajax = require('ultra.ajax'),
      rsa  = require('ultra.rsa');
    ...
    this.auth = {
      getMobileSession : function(params, callbacks){
        ...
        params = {
          ...
          authToken : rsa.md5(params.username + rsa.md5(params.password))
        };
